...
class KaraController extends GetxController {
  final ScrollController scrollController = ScrollController();
  List<CharacterModel> _karaData = [];
  ...
  Future<void> getAllData() async {
    ...
    try {
      _karaData = _karaData
        ..addAll(
          await ApiService.getKaraData(page: _currentPage.value),
        );
