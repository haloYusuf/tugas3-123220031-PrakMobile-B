...
import 'akatsuki_controller.dart';

class AkatsukiPage extends StatelessWidget {
  const AkatsukiPage({super.key});

  @override
  Widget build(BuildContext context) {
    AkatsukiController controller = Get.put(AkatsukiController());
    return Scaffold(
      body: Center(
        child: Obx(
          () {
